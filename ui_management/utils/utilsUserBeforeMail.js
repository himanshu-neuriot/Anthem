                                        ...
                                        if(resultUserFetchAllAllUsers.result.length == 0){
                                           ...
                                           let thisdate=new Date().toISOString().slice(0,10); 
                                            for(let v of resultUserFetchAllAllUsers.result){
                                                notiTableValues.push([v.userID,'D',thisdate,null,null,null,null]);
                                            }
...
module.exports.userFetchAllInGroup = userFetchAllInGroup;
module.exports.userDeleteAll = userDeleteAll;
module.exports.userDeleteMember = userDeleteMember;
